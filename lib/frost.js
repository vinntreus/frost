...
function frost(){
  var store, idGenerator, incrementalSnapshot, defaultEventData, defaultSnapshotKey, handlers;
  ...
  function init(options){
    ...
    idGenerator = options.idGenerator || idGeneratorDate;
    incrementalSnapshot = _.isUndefined(options.incrementalSnapshot) ? true : false;
    defaultEventData = options.defaultEventData || {};
    defaultSnapshotKey = options.defaultSnapshotKey;
    handlers = {};
